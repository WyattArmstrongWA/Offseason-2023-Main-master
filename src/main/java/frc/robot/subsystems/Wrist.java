...
public class Wrist extends SubsystemBase {
  ...
  public final TalonFX wrist = new TalonFX(Constants.WristMotorID);
  private final TalonFXSensorCollection encoder   = new TalonFXSensorCollection(wrist);
  public final PIDController pid = new PIDController(0.5, .3, 0);
  private double setPoint = 0;
  
  // Constants
  private static final int BOTTOM_ENCODER_VALUE = -30000;
  private static final int TOP_ENCODER_VALUE = -100000;
